...
const makeTheme = (dark, chosenSunset, chosenPlants) => dark
  ...
  : {
      ...
      tabBar:{ bg:"oklch(100% 0 0 / 0.2)", activeBg:"oklch(100% 0 0 / 0.4)", activeText:"oklch(100% 0 0)", inactiveText:"oklch(0% 0 0 / 0.35)", indicatorFn:(colId)=>({today:"oklch(55% 0.22 25)",week:"oklch(50% 0.18 290)",fyi:"oklch(45% 0 0)",blocked:"oklch(45% 0 0)"})[colId] },
    };
...
function Card({ item, onDone, onSnooze, t, isMobile, isXL, dark, filterTag, setFilterTag }) {
  ...
  return (
    <div onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      ...
      {/* Tags */}
      {item.tags?.length>0 && (
        <div style={{display:"flex",gap:6,flexWrap:"wrap",padding:"6px 10px 21px"}}>
          {item.tags.map(tag=>(
